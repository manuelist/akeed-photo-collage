...
var RowPhotos = function (props) {
    var height = props.height, photos = props.photos, layoutNum = props.layoutNum, remainingNum = props.remainingNum, showNumOfRemainingPhotos = props.showNumOfRemainingPhotos, openLightbox = props.openLightbox, imageRadius = props.imageRadius;
    return (react_1.default.createElement(exports.SC.PhotoRow, { rowHeight: height }, photos.map(function (data, i) {
        return (react_1.default.createElement(exports.SC.PhotoGrid, { key: i, "data-id": data.id, onClick: function (e) { return openLightbox(e.currentTarget.dataset.id); } },
            showNumOfRemainingPhotos &&
                remainingNum > 0 &&
                data.id === layoutNum - 1 ? (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(exports.SC.PhotoThumb, { thumb: data.source, imageRadius: imageRadius })));
    })));
};
exports.ReactPhotoCollageComponent = react_1.default.memo(function (props) {
    var width = props.width, height = props.height, layout = props.layout, layoutPhotoMaps = props.layoutPhotoMaps, layoutNum = props.layoutNum, remainingNum = props.remainingNum, showNumOfRemainingPhotos = props.showNumOfRemainingPhotos, openLightbox = props.openLightbox, imageRadius = props.imageRadius;
    return (react_1.default.createElement(exports.SC.PhotoCollage, { collageWidth: width }, layout.map(function (data, i) {
        return (react_1.default.createElement(RowPhotos, { key: i, height: height[i], photos: layoutPhotoMaps[i], openLightbox: openLightbox, layoutNum: layoutNum, remainingNum: remainingNum, showNumOfRemainingPhotos: showNumOfRemainingPhotos, imageRadius: imageRadius }));
    })));
});
